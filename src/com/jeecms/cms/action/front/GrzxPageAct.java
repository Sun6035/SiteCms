...
import static com.jeecms.cms.Constants.TPLDIR_grzx;
...
@Controller
public class GrzxPageAct {
	private static final Logger log = LoggerFactory
			.getLogger(GrzxPageAct.class);
	/**
	 * 首页模板名称
	 */
	...
	public static final String TPL_ADSPACE = "tpl.grzxindex";
	 ...
	 * @return
	 */
	@RequestMapping(value = "/grzx*.jspx", method = RequestMethod.GET)
	public String index(HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request,site.getSolutionPath(),TPLDIR_grzx, TPL_ADSPACE);
	}
