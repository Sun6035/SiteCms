...
import static com.jeecms.cms.Constants.TPLDIR_sysgl;
...
@Controller
public class SysglPageAct {
	private static final Logger log = LoggerFactory
			.getLogger(SysglPageAct.class);
	/**
	 * 首页模板名称
	 */
	...
	public static final String TPL_ADSPACE = "tpl.sysglindex";
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sysgl*.jspx", method = RequestMethod.GET)
	public String index(HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		model.put("returnUrl",url);
		return FrontUtils.getTplPath(request,site.getSolutionPath(),TPLDIR_sysgl , TPL_ADSPACE);
	}
