...
import static com.jeecms.cms.Constants.ZLK_PATH;
...
/*	private static final String ZLK_PATH = null;*/	
	/**
	 * 返回首页模板
	 * @return
	 */
	...
	/**
	 * 获得模板资源路径。如：/z/school/www
	 * 
	 * @return
	 */
	public String getZlkPath() {
		return ZLK_PATH + "/" + getPath();
	}
