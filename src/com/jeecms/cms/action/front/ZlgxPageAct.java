...
import static com.jeecms.cms.Constants.TPLDIR_zlgx;
...
@Controller
public class ZlgxPageAct {
	private static final Logger log = LoggerFactory
			.getLogger(ZlgxPageAct.class);
	/**
	 * 首页模板名称
	 */
	...
	public static final String TPL_ADSPACE = "tpl.zlgxindex";
	 ...
	 * @return
	 */
	@RequestMapping(value = "/zlgx*.jspx", method = RequestMethod.GET)
	public String index(HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request,site.getSolutionPath(),TPLDIR_zlgx , TPL_ADSPACE);
	}
